...
namespace TaskPatrolV2.SearchHandlers
{
    public class TaskSearchHandler : SearchHandler
    {
        public IList<MyTasks> Tasks { get; set; }
        ...
        protected override void OnQueryChanged(string oldValue, string newValue)
        {
            ...
            {
                ItemsSource = Tasks.Where(task => task.FullTask.ToLower().Contains(newValue.ToLower())).ToList();
            }
        }
